...
import { Eye, EyeOff, IdCard, Unplug } from 'lucide-react';
import { HqPinSignIn } from '@/screens/login/components/hq-pin-sign-in';
...
import { isHqOperator, statusCopy, type FormStatus } from './LoginScreen.utils';
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  Select an operator, then enter PIN. Password remains available.
                </p>
              </div>
          ...
          {showPasswordForm ? (
            <form onSubmit={onSubmit} className="space-y-4" noValidate>
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  Authenticate the MASTER session for this console.
                </p>
              </div>
              {listFailed ? (
                <p
