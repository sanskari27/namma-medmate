...
class CustomerRollbackTest {
  ...
  static final PostgreSQLContainer<?> POSTGRES =
      new PostgreSQLContainer<>("postgres:16-alpine")
          .withDatabaseName("nammamedmate_customer_rollback")
  ...
  @Test
  void invalidCreateLeavesNoPartialCustomer() throws Exception {
    Tenant tenant = persistTenant("roll-cust", "Roll Customer");
    persistPlan(tenant.getId(), PlanCode.FREE);
    persistUser(tenant.getId(), "owner@roll-cust.local", AppUserRole.pharmacy_owner);
    Cookie cookie = login("owner@roll-cust.local");
